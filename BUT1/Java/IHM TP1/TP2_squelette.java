...
/**
 * la Classe FrameSquelette permet de construire l'interface graphique demand�e dans l'exercice 1 -
...
class FrameSquelette extends JFrame {
  ...
  private void CreateInterface() {
    ...
    panneau = new Pan();
    panneau.addKeyListener(
        new KeyAdapter() {
          public void keyPressed(KeyEvent e) {
            // Add 20 to x when the right arrow key is pressed and subtract 20 from x when
            // the left arrow key is pressed.
            // Add 20 to y when the down arrow key is pressed and subtract 20 from y when
      ...
      Y.addActionListener(
          new ActionListener() {
            public void actionPerformed(ActionEvent e) {
              ...
              for (int i = 0; i < 10; i++) for (int j = 0; j < 25; j++) t[i][j] = 0;
  ...
  private boolean IsFull() {
    // return true if all the cells are visited
    for (int i = 0; i < 10; i++) for (int j = 0; j < 25; j++) if (t[i][j] == 0) return false;
    return true;
  }
  ...
  /**
   * la Classe Pan correspond au JPanel dans lequel le dessin des traces du disque ainsi que le
   * disque jaune sont r�alis�s
   */
        ...
        for (int j = 0; j < 25; j++)
          if (t[i][j] == 1)
            g.fillOval(
                ...
                20 * i + 10,
                5,
                5); // Si une case a �t� visit�e, dessiner un rond jaune
    }
  }
}
