...
public class Controller {
  ...
  public Controller(Model model, View view) {
    ...
    String[] algorithms = {
      "Breadth first", "Depth first", "Greedy best first", "Dijkstra", "A*", "IDA*"
    };
    for (String algorithm : algorithms) algorithmSelector.addItem(algorithm);
    ...
    view.waitTime.addActionListener(
        e -> {
          try {
