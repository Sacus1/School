...
public class Exo4 extends RopewayScene {
  ...
  /**
   * Constructs the 3D scene used for the present exercice. Prepares the intermediate storage
   * objects.
   *
  ...
  private Exo4(int p1, String[] p2) {
    ...
    angle_inc.mult(mat);
    cabin_pose = new Matrix(cableCenter()[0], cableCenter()[1] - cableRadius(), cableHeight());
  }
