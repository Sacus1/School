...
public class Exo2 extends RopewayScene
{
  ...
  public boolean nextStep (float[] pose)
  {
    ...
    pose[0] = cosTheta; pose[1] = -sinTheta; pose[2] = 0; pose[3] = cableStart()[0]+ distance * sinTheta;
    pose[4] = sinTheta; pose[5] = cosTheta; pose[6] = 0; pose[7] = cableStart()[1] + distance * cosTheta;
