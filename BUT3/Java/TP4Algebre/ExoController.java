  ...
  private void processKeyEvent (KeyEvent e, boolean pressed)
  {
    switch (e.getKeyCode ())
    {
      ...
      case KeyEvent.VK_UP :
        if (pressed)
          if (e.isControlDown ())
            myView.observer().move (Observer.MOVE_FRONT);
      ...
      case KeyEvent.VK_DOWN :
        if (pressed)
          if (e.isControlDown ())
            myView.observer().move (Observer.MOVE_BACK);
      ...
      case KeyEvent.VK_LEFT :
        if (pressed)
          if (e.isControlDown ())
            myView.observer().move (Observer.MOVE_LEFT);
      ...
      case KeyEvent.VK_RIGHT :
        if (pressed)
          if (e.isControlDown ())
            myView.observer().move (Observer.MOVE_RIGHT);
