  ...
  public static void main(String[] args) {
    ...
    button.addActionListener(
        (e) -> {
          ...
          if (numeroDeVolField.getText().isEmpty()
              || heureDeDepartField.getText().isEmpty()
              || heureArriveField.getText().isEmpty()
              || aeroportDepartField.getText().isEmpty()
              || aeroportArriveField.getText().isEmpty()) {
            JOptionPane.showMessageDialog(
                frame, "Veuillez remplir tous les champs", "Erreur", JOptionPane.ERROR_MESSAGE);
            return;
          }
          ...
          try {
            ...
            JOptionPane.showMessageDialog(
                frame, "Le numéro de vol doit être un nombre", "Erreur", JOptionPane.ERROR_MESSAGE);
            return;
          }
          ...
          if (heureArriveSplit.length != 2) {
            JOptionPane.showMessageDialog(
                frame,
                "L'heure d'arrivée doit être au format hh:mm",
                "Erreur",
                JOptionPane.ERROR_MESSAGE);
            return;
          }
          ...
          if (heuresDepart > heuresArrive
              || (heuresDepart == heuresArrive && minutesDepart > minutesArrive)) {
            JOptionPane.showMessageDialog(
                frame,
          ...
          try {
            ...
            JOptionPane.showMessageDialog(
                frame,
                "L'aéroport de départ doit être un nombre",
                "Erreur",
                JOptionPane.ERROR_MESSAGE);
            return;
          }
          ...
          try {
            ...
            JOptionPane.showMessageDialog(
                frame,
                "L'aéroport d'arrivée doit être un nombre",
                "Erreur",
                JOptionPane.ERROR_MESSAGE);
            return;
          }
          ...
          sql.executeUpdate(
              "INSERT INTO Vol VALUES ("
                  + numVol
                  + ", '"
                  + heureDeDepartField.getText()
                  + "', '"
                  + heureArriveField.getText()
                  + "', "
                  + aeroportDepartValue
                  + ", "
                  + aeroportArriveValue
