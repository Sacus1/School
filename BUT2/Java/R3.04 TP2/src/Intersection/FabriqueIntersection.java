...
public class FabriqueIntersection implements FabriqueVehicule {
  ...
  public FabriqueIntersection(
      double probaVoiture, double probaBus, double probaBic, double probaPieton) {
  ...
  public Vehicule creerVehicule() {
    ...
    if (rand < probaVoiture) fabriqueVehicule = new FabriqueVoiture();
    else if (rand < probaVoiture + probaBus) fabriqueVehicule = new FabriqueBus();
    else if (rand < probaVoiture + probaBus + probaBic) fabriqueVehicule = new FabriqueBicyclette();
    else fabriqueVehicule = new FabriquePieton();
