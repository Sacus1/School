...
class GreyImageTest {
  ...
  public void loadPGM() throws IOException, WrongSizeException, OutOfBoundException {
    ...
    GreyImage img =
        GreyImage.loadPGM(
            "/home/sacus/Documents/Code/School/BUT2/Java/GreyImage/src/test/resources/Lena.pgm");
    // image is 241x375
  ...
  public void writePGMNegate() throws IOException, OutOfBoundException, WrongSizeException {
    ...
    img.negative();
    img.writePGM(
        "/home/sacus/Documents/Code/School/BUT2/Java/GreyImage/src/test/resources/Lena2.pgm");
  }
  ...
  public void writePGMAllImageNegate() throws IOException, OutOfBoundException, WrongSizeException {
    ...
    for (String path : paths) {
      if (path.endsWith(".pgm")) {
        GreyImage img =
            GreyImage.loadPGM(
                "/home/sacus/Documents/Code/School/BUT2/Java/GreyImage/src/test/resources/" + path);
        img.negative();
        img.writePGM(
            "/home/sacus/Documents/Code/School/BUT2/Java/GreyImage/src/test/resources/"
                + path
                + ".out");
      }
    }
