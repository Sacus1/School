...
public class Hotel implements java.io.Serializable {
  ...
  public String toString() {
    StringBuilder s =
        new StringBuilder("Chambres libres:")
  ...
  /**
   * Ajoute une chambre à la liste des chambres libres , lui attribue un numéro de chambre et
   * incrémente le nombre de chambres si la chambre n'a pas déja un numéro de chambre
   */
