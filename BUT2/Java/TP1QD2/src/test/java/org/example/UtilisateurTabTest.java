...
class UtilisateurTabTest {
  ...
  void testConstructor() {
    UtilisateurTab utilisateur =
        new UtilisateurTab("John", "Doe", "John.doe@mail.com", "20-11-2023", 10, 10, 10);
  ...
  void testConstructorDateInvalid() {
    assertThatThrownBy(
            () -> new UtilisateurTab("John", "Doe", "John.doe@mail.com", "2020-11-32", 10, 10, 10))
  ...
  void testConstructorStringOnly() {
    assertThatThrownBy(
            () -> new UtilisateurTab("1", "Doe", "John.doe@mail.com", "20-11-2023", 10, 10, 10))
        .isInstanceOf(IllegalArgumentException.class);
  }
  ...
  void testConstructorStringOnly2() {
    assertThatThrownBy(
            () -> new UtilisateurTab("John", "1", "John.doe@mail.com", "20-11-2023", 10, 10, 10))
        .isInstanceOf(IllegalArgumentException.class);
  }
