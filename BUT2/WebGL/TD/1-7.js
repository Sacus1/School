...
function createStairs() {
	...
	let stepVertical = new THREE.BoxGeometry(stepWidth, verticalStepHeight, stepThickness);
	let stepHorizontal = new THREE.BoxGeometry(stepWidth, stepThickness, horizontalStepDepth);
	let stepMesh;
