...
function fillScene() {
	...
	const minuteHandMaterial = new THREE.MeshLambertMaterial({color: 0x226894});
	const hourHandMaterial = new THREE.MeshLambertMaterial({color: 0xE02BFB});
	...
	const sphere = new THREE.Mesh(
		new THREE.SphereGeometry(.5, 32,16), hourHandMaterial);
	sphere.position.y = 18;	// move the hand above the other hand

	// YOUR CODE HERE:
	sphere.scale.set(4,4,60);
	sphere.rotation.y = -60 * Math.PI/180;
